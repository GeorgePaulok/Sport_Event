...
//			window.open("/TBulletAction/listMoreTBulletsForAllUser.action?pageNo=1&searchOpt=true&pageSize=20&uuids=站内搜索&endTime3="+allsitesearchvalue);
    ...
    float: left;
"></div>
        <div id="welc" style="float:right;">
            <div class="norw2" style="margin-top:10px;margin-left: 10px;"><span id="welcome">欢迎</span><div class="tipd"></div></div>
    ...
    <div class="top">
        ...
        <div  class="topleft">
            ...
            <div style="margin-left: 20px;" id="navTop">
                <div class="nav_fgx"><span class="tit14 bt">&nbsp;功能导航</span></div>
                <div style="margin-top:20px"></div>
                <%
                    String team_name = request.getParameter("Team_Name");
                    out.println(" <div class='btnLight cp' onclick=\"window.open('Sports_Event_List.jsp?team_name="+team_name+"\')\">");
                %>
                ...
                <%
                    out.println(" <div class='btnLight cp' onclick=\"window.open('Add_Player.jsp?team_name="+team_name+"\')\">");
                %>
                ...
                <%
                    out.println(" <div class='btnLight cp' onclick=\"window.open('Team_Management.jsp?team_name="+team_name+"\')\">");
                %>
                    <span class="spanBtn">运动员管理</span>
                </div>
	...
	<span style="font-size: 14px;padding-right:10px;line-height:30px" onclick="CloseDiv('MyDiv','fade')">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="tab_list">
                        <tr>
                            <td><img src='../web_resources/images/pic_neir.gif' border='0' align='absmiddle'/>
                                <a href='web_TBulletAction1/showTBulletDetails49a4.html' target="_blank" style='color: red;'>
                                    通知1</a>
                            </td>
                        </tr>
                        <tr>
        ...
        <div>
            <div class="topleft">
                ...
                <div style="display:none" id="navBottom">
                    <div class="btnBlue cp" onclick="window.open('baomingPre.html')">
                        <span class="spanBtn">比赛报名</span>
                    </div>
                    <div class="btnLight cp" onclick="window.open('search/search.html')">
                        <span class="spanBtn">教练员查询</span>
                    </div>
                    <div class="btnLight cp" onclick="window.open('athleteReg.html')">
                        <span class="spanBtn">运动员注册</span>
                    </div>
                    <div class="btnLight cp" onclick="window.open('search/search.html')">
                        <span class="spanBtn">运动员查询</span>
